...
import V2.PrettyPrint (D (..))
import V2.Syntax
import V2.TcEnvironment.ModuleEnvironment (TcMonad)
import qualified V2.TcEnvironment.ModuleEnvironment as Env
import qualified V2.TcEnvironment.TermEnvironment as Env

-- | Checks if two lists of terms are equal. 
-- If they do not have equal lengths then the encapsulating terms provided were not equal.
